...
#   - Final Tables and Figures/ (dilution-panel image files and a pooled
#     library-level correlation plot retained as an intermediate output)
...
#     libraries, including four MRD-negative 0% references, are used in
#     Supplementary Table 7 and retained as an intermediate plot. They are not
#     the final Figure 3C. The final Figure 3C uses patient-level correlation
#     summaries and is generated by
#     3_1C_Summarize_dilution_correlations_across_patients.R.
...
# Scripts_2025/Final_Scripts/final_manuscript_objects. This script contains a
# historical Figure_3C staging call for the pooled library-level plot; the
# patient-level Figure 3C produced by
# 3_1C_Summarize_dilution_correlations_across_patients.R is the final panel.
