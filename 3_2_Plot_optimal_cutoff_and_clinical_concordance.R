...
ggsave(
  filename = file.path(OUTPUT_DIR_FIGURES, "Fig_4I_BM_positivity_by_tech_updated_non_frontline2.png"),
  plot     = p_non_grouped,
  width    = 3.5,
  height   = 4,
  dpi      = 500
...
non <- dat %>% filter(Cohort == "Non-frontline") %>% filter(!is.na(BM_base_zscore_call))
