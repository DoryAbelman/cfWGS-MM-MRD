...
#    Sample_Code.
#
# Supplementary Table 6 assembly
# ------------------------------
# The classifier-performance sheet starts from the preserved expanded-test
# table generated by 3_1, then refreshes the six full-cohort fragmentomics-only
# rows from the current 37-sample masked test set. The clustered-bootstrap,
# one-sample-per-patient, and matched-workflow sheets are calculated here. This
# script therefore does not recompute all 32 classifier-performance rows.
#
# Inputs
# ------
...
# The final XLSX sanitization step also requires a system `zip` executable.
