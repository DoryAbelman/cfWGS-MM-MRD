...
#
# Build alternate AUC-summary plots from the fully patient-grouped repeated
# nested-CV summaries. These panels report threshold-free discrimination (AUC)
# with patient-clustered bootstrap intervals.
#
# Manuscript role
#   This script is not used to generate the final Figure 3A or Figure 4A. Those
#   panels use the 50-repeat compact ROC plots generated later in the grouped-CV
#   workflow. This older script is retained as a record of an alternate AUC and
#   confidence-interval display and can be moved to the support-analysis archive.
#
# Inputs
#   Two primary_performance_summary.csv files generated by
#   6_12_Patient_Grouped_Repeated_Nested_CV.R: one containing the original
#   three headline models and one containing Blood_Sites. The current defaults
#   point to the historical July 31 runs used for this alternate plot.
#
# Outputs
#   A versioned directory under
#   Output_figures_2025/patient_grouped_repeated_nested_cv/ containing separate
#   BM-informed and baseline-plasma-informed PNG/PDF plots, their plotted source
#   table, input/output checksum manifests, and a RUN_COMPLETE marker.
#
# R packages
...
# ----------------------------------------------------------------------------
# 3. Create the panel source data and hash both inputs
# ----------------------------------------------------------------------------
source_data <- raw %>%
  transmute(
    model,
